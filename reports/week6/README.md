...
- **Scope Summary:** Order history + dislike feature (US-015), AI recommendation safety hardening (allergen/exclusion guarantees, meal-type recognition, beverage exclusion), authentication/session bug fixes surfaced by UAT.
