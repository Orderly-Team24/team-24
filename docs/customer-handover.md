...
- **Scanning menu photos works best for one common layout** (dish name on one line, description and price below it). Two-column menus or handwritten specials boards may not scan cleanly yet.
